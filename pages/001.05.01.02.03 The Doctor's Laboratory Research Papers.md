...
- Date: 19th of January 1582Ea
  ...
  Personal note: The war is eating up all the resources. It has been like that for the past four years but until now it only affected the regions up north  never affected the citizens of Arx. The funding for my project has been cut in half. I have to deliver results otherwise my project is finished. I have to launch the human testing phase no matter the cost. I just struggle to find suitable candidates for the procedure. Maybe joining the war effort might provide me with the specimens I need to finish my research.
