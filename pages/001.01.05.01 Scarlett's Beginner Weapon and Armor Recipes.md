...
- Although I never used Shields, I often saw my comrades using them to great effect. Shield are most effective if used together with a wand for the extra protection. But melee fighters can use them as well, although their effectiveness suffers a little bit due to them only being able to wield one weapon. If you decide to use a shield with a melee weapon I'd recommend using a One-Handed mace as they are made to dodge enemy attacks and that synergizes particularly well with shields. But feel free to decide that on your own. Here is the recipe for the two different types of shields I crafted so far.
  |Result   |Tool 1   |Tool 2   |Ingredient 1   |Ingredient 2   |Ingredient 3   |Ingredient 4   |Ingredient 5   |Bonus   |
  |Magical Shield   |Workbench   |   |Cloth Scraps   |Scale Scraps   |Wood Chips   |Rope   |   |More Magic Armor: 6/8, +5%Blocking Chance, +3%Dodging; 8/12, +5%Blocking Chance, +3%Dodging   |
  |Physical Shield   |Workbench   |   |Leather Scraps   |Plate Scraps   |Wood Chips   |Rope   |   |More Physical Armor: 8/6, +5%Blocking Chance, +3%Dodging; 12/8, +5%Blocking Chance, +3%Dodging   |